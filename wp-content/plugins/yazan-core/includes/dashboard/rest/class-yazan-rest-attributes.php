...
class Yazan_REST_Attributes {
	...
	public static function register_routes() {
		...
		register_rest_route(
			...
			'/attributes',
			array(
				Yazan_REST_Guard::args( WP_REST_Server::READABLE, array( __CLASS__, 'index' ), 'attributes.view' ),
				Yazan_REST_Guard::args( WP_REST_Server::CREATABLE, array( __CLASS__, 'create' ), 'attributes.create' ),
			)
		);
		...
		register_rest_route(
			...
			'/attributes/(?P<id>\d+)',
			array(
				Yazan_REST_Guard::args( WP_REST_Server::EDITABLE, array( __CLASS__, 'update' ), 'attributes.edit' ),
				Yazan_REST_Guard::args( WP_REST_Server::DELETABLE, array( __CLASS__, 'destroy' ), 'attributes.delete' ),
			)
		);
	}
